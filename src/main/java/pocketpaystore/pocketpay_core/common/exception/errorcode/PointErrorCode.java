...
public enum PointErrorCode implements ErrorCode {
	...
	POINT_RESERVATION_NOT_FOUND("POINT_003", "포인트 예약이 존재하지 않습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
	POINT_EARN_LOG_NOT_FOUND("POINT_004", "포인트 적립 로그가 존재하지 않습니다.", HttpStatus.INTERNAL_SERVER_ERROR);
